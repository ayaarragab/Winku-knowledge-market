...
if(isset($_POST['unfollow']) && isset($_POST['id']))
{
	UserToUser::unfollowUser($_POST['id']);
}
...
?>
	<section>
		...
		<div class="feature-photo">
			<div class="add-btn">
			<span>Followers: <?php $num=userfollowermapper::numOfRow($_GET['id'],'userId'); echo $num['num'];?></span>
                            ...
                            <div class="central-meta">
									<div class="frnds">
										<ul class="nav nav-tabs">
											 <li class="nav-item"><a class="active" href="#frends" data-toggle="tab">Following</a> <span><?php $num=userfollowermapper::numOfRow($_GET['id'],'userId'); echo $num['num'];?></span></li>
										...
										<div class="tab-content">
										  <div class="tab-pane active fade show " id="frends" >
											...
											UserToUser::viewFollowings($_GET['id']);
											?>
										</ul>
										<div class="chat-box">
											<div class="chat-head">
